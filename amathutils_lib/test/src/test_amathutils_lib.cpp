...
TEST(TestSuite, DistanceFromSegment1){
	...
	ASSERT_DOUBLE_EQ(amathutils::distanceFromSegment(p, line_p1, line_p2), 1.0) << "Point is 1m away from segment";
}
...
TEST(TestSuite, DistanceFromSegment2){
	...
	ASSERT_DOUBLE_EQ(amathutils::distanceFromSegment(p, line_p1, line_p2), -2.0) << "Point is 2m away from p1";
}
...
TEST(TestSuite, DistanceFromSegment3){
	...
	ASSERT_DOUBLE_EQ(amathutils::distanceFromSegment(p, line_p1, line_p2), 3.0) << "Point is 3m away from p1";
}
